# used to send some cut-paste messages to gmail
...
if __name__ == '__main__':	
	...
	mymail = Bimail('Rasp-pi message ', ['rsmitra@gmail.com'])

	#start html body. 
	mymail.htmladd('msg:' + 'https://www.dropbox.com/1/oauth/authorize?oauth_token=HL1dNtegw0NO9Duz')
